    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const SizedBox(height: 30), // Reduced gap from AppBar
            const Text(
              'Instructions',
              style: TextStyle(
                fontSize: 22,
            ...
            const Spacer(), // Pushes button to bottom with margin
            Padding(
              padding: const EdgeInsets.only(bottom: 50.0), // Bottom spacing
              child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
